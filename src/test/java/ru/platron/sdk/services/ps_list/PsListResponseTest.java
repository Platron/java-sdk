...
public class PsListResponseTest {
	...
	@Test
	public void test() {
		PsListResponse response = (PsListResponse) XmlUtils.fromXml(Utils.readFile("src/test/resources/services/ps_list_response.xml"), PsListResponse.class, PsListResponse.class);
